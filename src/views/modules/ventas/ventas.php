                ...
                <div class="col-8 col-sm-8">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="unidades"
                            placeholder="Cantidad de productos Unidades:" value="1" disabled/>
                        <div id="stock">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control text-md-center ventas" type="text" placeholder="0.00"
                                id="disabledTextInput" name="totalVenta" readonly required="" />
                        </div>
                        <div class="row">
                            <div class="col-8 col-sm-6">
                                <span class="label label-default">
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo date('d-m-Y'); ?> "
                                        name="fechaVenta" id="fecha" readonly />
                                </div>
                            </div>
                            <div class="col - 4col - sm - 6">
                                ...
                                <div class="input - group">
                                    ...
                                    <input class="form-control text-md-center ventas" type="text" id="numFac"
                                        name="numFac" value="<?php echo $key['total'] + 1; ?>" readonly />
                                    <?php endforeach?>
                                </div>
                            </div>
                        </div>
...
?>
            ...
            <div class="row">
                    ...
                    <table class="table table-bordered table-sm" id="ventas">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">
                                    <a
                                        href="index.php?action=borrarVenta&idTemp=<?php echo $key['idTemp'] ?> &idProducto=<?php echo $key['idProducto'] ?>&unidad=<?php echo $key['unidad'] ?> ">
                ...
                <div class="col-md-3">
                    ...
                    <tr class="bg-primary ">
                        ...
                        <span class="alert alert-info"><strong>Cliente:</strong>
                            <?php echo $key['nombreCliente'] . ' ' . $key['apellidoCliente'] ?></span>
                </div>
        ...
        <form method="post">
            ...
            <?php $idFact = VentasController::getFecturaController();?>
            <?php foreach ($idFact as $key): ?>
            <input class="form-control text-md-center ventas" type="hidden" id="numFac" name="numFac"
                value="<?php echo $key['total'] + 1; ?>" readonly />
            <?php endforeach?>
        </form>
        <?php endif?>
...
?>
        <table class="table table-bordered table-sm" id="tablas">
            ...
            <tr>
                ...
                <td align="center">
                    <a href=" #" onclick="abrirVentana('tcpdf/pdf/factura.php?numFac= <?php echo $key['numFac'] ?> ')"
                        class="btn btn-outline-info btn-sm">
                        <i class="fa fa-download">
                        </i>
                    </a>
                    <a href="index.php?action=factura&deleteFactura= <?php echo $key['numFac'] ?> "
        ...
        <div class="row">
            <div class="col-md-6 mx-md-auto">
                ...
                <form method="post">
                    ...
                    <center><input type="submit" name="ventaDiarias" class="btn btn-outline-primary" value="Consultar">
                    </center>
                    <div class="clearfix"><br> </div>
                </form>
            </div>
            <div class="col-md-9 top">
                ...
                <table class="table table-striped table-sm" id='tablas'>
                    ...
                    <tr>
                        ...
                        <td align="center"><?php echo 'Nro: ' . $key['numFac'] . ' ' . 'Tipo:' . $key['tipoFactura'] ?>
                        </td>
            ...
            <div class="col-md-3">
                <div class="alert alert-info" role="alert">
                    <h5> <strong> Ventas Total del dia <?php echo date("d-m-Y", strtotime($key['fechaVenta'])); ?>:
                            <span class="text-gray-dark"> <i class="fa fa-usd"></i>
                                <?php echo $total; ?></span></strong></h5>
                </div>
            </div>
            <?php endif?>
        </div>
