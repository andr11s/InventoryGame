        ...
        <div class="card">
            <div class="card-block">
                ...
                <table class="table table-bordered table-sm" id="tablas">
                    ...
                    <tr>
                        <td class='tooltips' data-toggle='tooltip' data-placement='top'
                            title='id Producto :<?php echo $key['idProducto'] ?>'>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="form">
                    ...
                    <input type="text" class="form-control" id="nombreProductos" placeholder="Nombre del Producto"
...
$a->getCategoriasSelectController();?>
            ...
            <div class="col-md-6">
                <div class="center">
                    <input type="submit" name="agragarpro" id="button" value="Agregar Productos"
