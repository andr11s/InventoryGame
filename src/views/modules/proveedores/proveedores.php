...
?>
          ...
          <tr>
            <td align='center' class='tooltips' data-toggle='tooltip' data-placement='top'
              title='Apellido  : <?php echo $key['apellidoProveedor'] ?>'><?php echo $key['nombreProveedor'] ?></td>
            <td><?php echo $key['nombreEmpresa'] ?></td>
            <td><?php echo $key['telefonoProveedor'] ?></td>
            <td><?php echo $key['direccionProveedor'] ?></td>
            <td align='center' class='tooltips' data-toggle='tooltip' data-placement='top'
              title='Provincia  : <?php echo $key['nombreProvincia'] ?>'><?php echo $key['nombreCiudad'] ?></td>

            <td align="center"><a href="index.php?action=editarProv&idEditProv=<?php echo $key['idProveedor'] ?>"><i
                  class="fa fa-edit btn btn-outline-primary btn-sm"></i></a> <a
                href="index.php?action=proveedores&idProv=<?php echo $key['idProveedor'] ?>"><i
                  class="fa fa-trash  btn btn-outline-danger btn-sm"></i></a>
            </td>
          </tr>
          <?php endforeach?>
        </table>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group" id="form">
                <label for="nombreProveedor" class="text-primary">Nombre Proveedor</label>
...
?>
                  ...
                  <option value="<?php echo $key['idCiudad'] ?>">
                    <?php echo $key['nombreCiudad'] . ' /' . $key['nombreProvincia'] ?></option>
                  <?php endforeach?>
                </select>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group" id="formapellido">
                <label for="apellidoProveedor" class="text-primary">Apellido Proveedor</label>
                <input type="text" class="form-control" id="apellidoProveedor" placeholder="Apellido del Proveedor"
                  name="apellidoProveedor" required="">
              </div>
              <span id="alertApellido"></span>
            </div>
            <div class="col-md-6">
              <div class="form-group" id="form">
                <label for="nombreCategorias" class="text-primary">Nombre Empresa</label>
                <input type="text" class="form-control" id="nombreEmpresa" placeholder="Nombre del la Empresa"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="telefonoProveedor" placeholder="Teléfono del la Empresa"
                  name="telefonoProveedor" required="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group" id="formDireccion">
                <label for="direccionProveedor" class="text-primary">Direción Proveedor</label>
                <input type="text" class="form-control" id="direccionProveedor" placeholder="dirección del la Empresa"
                  name="direccionProveedor" required="">
                <span id="AlertDirecccion"> </span>
              </div>
            </div>
            <input type="submit" name="agragarProveedor" id="button" value="Agregar Proveedor"
              class="btn btn-outline-danger center" id="button">
        </form>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nombreProveedor" placeholder="Nombre del Proveedor"
              name="nombreProveedor" value="<?php echo $key['nombreProveedor'] ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
...
?>
              ...
              <option value="<?php echo $row['idCiudad'] ?>">
                <?php echo $row['nombreCiudad'] . ' /' . $row['nombreProvincia'] ?></option>
              <?php endforeach?>
            </select>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="apellidoProveedor" placeholder="Apellido del Proveedor"
              name="apellidoProveedor" value="<?php echo $key['apellidoProveedor'] ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group" id="form">
            <label for="nombreCategorias" class="text-primary">Nombre Empresa</label>
            <input type="text" class="form-control" id="nombreEmpresa" placeholder="Nombre del la Empresa"
              name="nombreEmpresa" value="<?php echo $key['nombreEmpresa'] ?>">
            <span id="prove"></span>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="nombreCategorias" class="text-primary">Telefono Contacto</label>
            <input type="text" class="form-control" id="telefonoProveedor" placeholder="Teléfono del la Empresa"
              name="telefonoProveedor" value="<?php echo $key['telefonoProveedor'] ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="direccionProveedor" placeholder="dirección del la Empresa"
              name="direccionProveedor" value="<?php echo $key['direccionProveedor'] ?>">
          </div>
        </div>
        <input type="hidden" name="idProveedor" value="<?php echo $key['idProveedor'] ?>">
        <input type="submit" name="editarProveedor" id="button" value="Editar Proveedor"
          class="btn btn-outline-danger center" id="button">
    </form>
  </div>
</div>
